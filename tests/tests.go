...
func main() {
	...
	latex.MakeTable("../examples/simple_table.tex", entries)
	...
	latex.MakeLineGraph("../examples/line_graph.tex", linePts)
	latex.MakeColoredPointGraph("../examples/point_graph.tex", labelToMark, coloredPts)
}
